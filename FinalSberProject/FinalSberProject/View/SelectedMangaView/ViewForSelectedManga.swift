...
class ViewForSelectedManga: UIView {
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(ChapterOfMangaTableViewCell.self,
                           forCellReuseIdentifier: ChapterOfMangaTableViewCell.identifier)
    ...
    func drawView() {
        let path = UIBezierPath(roundedRect: viewForItems.bounds,
                                byRoundingCorners: [.topLeft, .topRight], cornerRadii: CGSize(width: 16, height: 16))
