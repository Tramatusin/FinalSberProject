...
### P.S.S: Забыл сказать о том, что в первый раз получение списков манги тоже неприятно продолжающие(но не всегда, на реальном устройстве быстро), потом все при помощи черной магии начинает работать быстрее
